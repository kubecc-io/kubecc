...
// DecodeMsg implements msgp.Decodable
func (z *TestKey3) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z TestKey3) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "counter"
	err = en.Append(0x81, 0xa7, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72)
	if err != nil {
...
// MarshalMsg implements msgp.Marshaler
func (z TestKey3) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "counter"
	o = append(o, 0x81, 0xa7, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x65, 0x72)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *TestKey3) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z TestKey3) Msgsize() (s int) {
	s = 1 + 8 + msgp.IntSize
	return
}

// DecodeMsg implements msgp.Decodable
func (z *TestKey4) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z TestKey4) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "value"
	err = en.Append(0x81, 0xa5, 0x76, 0x61, 0x6c, 0x75, 0x65)
	if err != nil {
...
// MarshalMsg implements msgp.Marshaler
func (z TestKey4) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "value"
	o = append(o, 0x81, 0xa5, 0x76, 0x61, 0x6c, 0x75, 0x65)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *TestKey4) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
