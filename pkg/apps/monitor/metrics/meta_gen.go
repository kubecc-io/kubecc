...
// DecodeMsg implements msgp.Decodable
func (z *ProviderInfo) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z ProviderInfo) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 3
	// write "uuid"
	...
	// write "component"
	err = en.Append(0xa9, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74)
	if err != nil {
		return
	}
...
// MarshalMsg implements msgp.Marshaler
func (z ProviderInfo) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 3
	// string "uuid"
	...
	// string "component"
	o = append(o, 0xa9, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74)
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *ProviderInfo) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z ProviderInfo) Msgsize() (s int) {
	s = 1 + 5 + msgp.StringPrefixSize + len(z.UUID) + 10 + msgp.Int32Size + 8 + msgp.StringPrefixSize + len(z.Address)
	return
}
...
func (z *Providers) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "items":
			...
			if z.Items == nil {
				z.Items = make(map[string]ProviderInfo, zb0002)
			...
			for zb0002 > 0 {
				...
				for zb0003 > 0 {
					...
					switch msgp.UnsafeString(field) {
					case "uuid":
						za0002.UUID, err = dc.ReadString()
						if err != nil {
							err = msgp.WrapError(err, "Items", za0001, "UUID")
							return
						}
					case "component":
						za0002.Component, err = dc.ReadInt32()
						if err != nil {
							err = msgp.WrapError(err, "Items", za0001, "Component")
							return
						}
					case "address":
						za0002.Address, err = dc.ReadString()
						if err != nil {
							err = msgp.WrapError(err, "Items", za0001, "Address")
							return
						}
					default:
						err = dc.Skip()
...
func (z *Providers) EncodeMsg(en *msgp.Writer) (err error) {
	...
	for za0001, za0002 := range z.Items {
		...
		err = en.WriteString(za0002.UUID)
		if err != nil {
			err = msgp.WrapError(err, "Items", za0001, "UUID")
			return
		}
		...
		err = en.WriteInt32(za0002.Component)
		if err != nil {
			err = msgp.WrapError(err, "Items", za0001, "Component")
			return
		}
		...
		err = en.WriteString(za0002.Address)
		if err != nil {
			err = msgp.WrapError(err, "Items", za0001, "Address")
			return
		}
...
func (z *Providers) MarshalMsg(b []byte) (o []byte, err error) {
	...
	for za0001, za0002 := range z.Items {
		...
		// string "uuid"
		o = append(o, 0x83, 0xa4, 0x75, 0x75, 0x69, 0x64)
		o = msgp.AppendString(o, za0002.UUID)
		// string "component"
		o = append(o, 0xa9, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74)
		o = msgp.AppendInt32(o, za0002.Component)
		// string "address"
		o = append(o, 0xa7, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73)
		o = msgp.AppendString(o, za0002.Address)
	}
	return
}
		...
		case "items":
			...
			for zb0002 > 0 {
				...
				for zb0003 > 0 {
					...
					switch msgp.UnsafeString(field) {
					case "uuid":
						za0002.UUID, bts, err = msgp.ReadStringBytes(bts)
						if err != nil {
							err = msgp.WrapError(err, "Items", za0001, "UUID")
							return
						}
					case "component":
						za0002.Component, bts, err = msgp.ReadInt32Bytes(bts)
						if err != nil {
							err = msgp.WrapError(err, "Items", za0001, "Component")
							return
						}
					case "address":
						za0002.Address, bts, err = msgp.ReadStringBytes(bts)
						if err != nil {
							err = msgp.WrapError(err, "Items", za0001, "Address")
							return
						}
...
func (z *Providers) Msgsize() (s int) {
	...
	if z.Items != nil {
		for za0001, za0002 := range z.Items {
			_ = za0002
			s += msgp.StringPrefixSize + len(za0001) + 1 + 5 + msgp.StringPrefixSize + len(za0002.UUID) + 10 + msgp.Int32Size + 8 + msgp.StringPrefixSize + len(za0002.Address)
		}
	}
	return
}
